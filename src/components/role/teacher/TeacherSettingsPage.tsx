...
export default function TeacherSettingsPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title={t.pages.teacher.settings.title}
        description={t.pages.teacher.settings.desc}
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900 mb-1">{t.pages.teacher.settings.title}</h2>
