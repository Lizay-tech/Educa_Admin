...
export default function TeacherCommunicationPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title={t.pages.teacher.communication.title}
        description={t.pages.teacher.communication.desc}
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900 mb-1">{t.pages.teacher.communication.title}</h2>
