...
export default function AdminPerformancePage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title={t.pages.admin.performance.title}
        description={t.pages.admin.performance.desc}
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900 mb-1">{t.pages.admin.performance.title}</h2>
