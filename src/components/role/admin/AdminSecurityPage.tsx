...
export default function AdminSecurityPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title={t.pages.admin.security.title}
        description={t.pages.admin.security.desc}
        icon={<Shield size={20} />}
      />

      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        <div className="w-16 h-16 bg-[#013486]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <Shield size={28} className="text-[#013486]" />
        </div>
        <h2 className="text-lg font-semibold text-gray-900 mb-1">{t.pages.admin.security.title}</h2>
