...
export default function StudentSettingsPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        title={t.pages.student.settings.title}
        description={t.pages.student.settings.desc}
        icon={<Settings size={20} />}
      />

      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
        <div className="w-16 h-16 bg-[#013486]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <Settings size={28} className="text-[#013486]" />
        </div>
        <h2 className="text-lg font-semibold text-gray-900 mb-1">{t.pages.student.settings.title}</h2>
